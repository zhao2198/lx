...
@Slf4j
@Configuration
@ConditionalOnPrefixProperty(prefix = "lx", value = LxDsProperties.class)
@ConditionalOnClass({
    DataSource.class, HikariDataSource.class, DataSourceSpy.class
})
public class LxDataSourceAutoConfiguration extends BaseAutoConfiguration implements
  ...
  public void postProcessBeanFactory(
    ...
    LxDsProperties locDsProperties = resolverSetting(LxDsProperties.class,
