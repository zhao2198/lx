...
import static com.lx.framework.configure.common.LxConstants.OKHTTP_ERROR_CODE;


@Slf4j
public class LxOkHttpClient {
  ...
  public LxOkHttpClient(OkHttpClient okHttpClient, ObjectMapper objectMapper) {
  ...
  private <T> BaseResult<T> returnBaseResult(Request request, TypeReference typeReference) {
    try {
      ...
      throw new ServiceException(OKHTTP_ERROR_CODE, e.getMessage());
    }
  }
