...
import com.lx.framework.configure.ConditionalOnPrefixProperty;
import com.lx.framework.configure.jdbc.LxDataSourceAutoConfiguration;
...
@ConditionalOnPrefixProperty(prefix = "lx", value = LxMybatisProperties.class)
@AutoConfigureAfter(LxDataSourceAutoConfiguration.class)
public class LxMybatisAutoConfiguration extends BaseAutoConfiguration implements
  ...
  public void postProcessBeanFactory(
    ...
    LxMybatisProperties locMybatisProperties = resolverSetting(LxMybatisProperties.class,
  ...
  SqlSessionFactory createSqlSessionFactory(
    ...
    sqlSessionFactoryBean.setVfs(LxSpringBootVFS.class);
