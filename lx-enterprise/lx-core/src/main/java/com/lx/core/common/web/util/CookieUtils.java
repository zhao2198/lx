package com.lx.core.common.web.util;


import com.lx.common.util.ValidateUtil;
...
/**
 * Cookie 工具类 Create Date: 2018年4月25日 下午3:45:28
 *
 * @version: V3.0.1
 * @author: zhao wei
 */
    ...
    private static final String getDomainName(HttpServletRequest request) {
        ...
        if (serverName == null || serverName.equals("")) {
            ...
            if (len > 3) {
                ...
                // 127.0.0.1 192.168.1.167
                if (ValidateUtil.isNum(domains[len - 3])) {
                    domainName = serverName;
                } else {
                    // www.xxx.com.cn
